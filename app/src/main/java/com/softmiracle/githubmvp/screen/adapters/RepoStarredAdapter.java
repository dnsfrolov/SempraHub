...
public class RepoStarredAdapter extends RecyclerView.Adapter {

    private List<User> mList;
    private OnItemClickListener<User> mListener;

    public RepoStarredAdapter(OnItemClickListener<User> listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RepoStarredHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        final RepoStarredHolder repoStarredHolder = (RepoStarredHolder) holder;
        repoStarredHolder.initData(holder.getAdapterPosition());

        repoStarredHolder.mCardView.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class RepoStarredHolder extends RecyclerView.ViewHolder {
