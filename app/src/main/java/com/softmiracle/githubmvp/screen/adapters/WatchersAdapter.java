...
public class WatchersAdapter extends RecyclerView.Adapter {

    private List<User> mList;
    private OnItemClickListener<User> mListener;

    public WatchersAdapter(OnItemClickListener<User> listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new WatchersHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        final WatchersHolder watchersHolder = (WatchersHolder) holder;
        watchersHolder.initData(holder.getAdapterPosition());

        watchersHolder.mCardView.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class WatchersHolder extends RecyclerView.ViewHolder {
